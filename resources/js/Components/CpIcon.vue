<template>
    ...
    >
        ...
        <template v-else-if="name === 'eye-off'">
            <path d="M3.98 8.223A10.477 10.477 0 001.934 12.222a1.012 1.012 0 000 .639C3.423 16.49 7.36 19.5 12 19.5c1.658 0 3.222-.394 4.601-1.092M17.357 17.349A10.461 10.461 0 0022.066 12.222a1.012 1.012 0 000-.639C20.577 7.51 16.64 4.5 12 4.5c-1.876 0-3.633.52-5.13 1.423" />
